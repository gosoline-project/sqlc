...
// baseQuerier implements the common Querier interface methods using an underlying dbQuerier.
...
func newBaseQuerier(logger log.Logger, executor exec.Executor, db dbQuerier) *baseQuerier {
	return &baseQuerier{
		logger:   logger,
		executor: executor,
		db:       db,

...
// LastInsertId provides a mock function for the type Result
func (_mock *Result) LastInsertId() (int64, error) {
	ret := _mock.Called()
...
func (_c *Result_LastInsertId_Call) Return(n int64, err error) *Result_LastInsertId_Call {
...
// RowsAffected provides a mock function for the type Result
func (_mock *Result) RowsAffected() (int64, error) {
	ret := _mock.Called()
...
func (_c *Result_RowsAffected_Call) Return(n int64, err error) *Result_RowsAffected_Call {
	_c.Call.Return(n, err)
	return _c
}
